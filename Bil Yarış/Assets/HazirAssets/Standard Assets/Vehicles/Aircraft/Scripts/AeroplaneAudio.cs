...
namespace UnityStandardAssets.Vehicles.Aeroplane
{
    public class AeroplaneAudio : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            m_EngineSoundSource.minDistance = 0;
            m_EngineSoundSource.maxDistance = 0;
            m_EngineSoundSource.loop = false;
            m_EngineSoundSource.dopplerLevel = 0;

            m_WindSoundSource.minDistance = 0;
            m_WindSoundSource.maxDistance = 0;
            m_WindSoundSource.loop = false;
            m_WindSoundSource.dopplerLevel = 0;
